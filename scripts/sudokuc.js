...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'sudokuc.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'sudokuc.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'sudokuc.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "sudokuc.js.mem" : null;




var STATIC_BUMP = 8176;
...
var _solveSudoku = Module["_solveSudoku"] = function() { return Module["asm"]["_solveSudoku"].apply(null, arguments) };
